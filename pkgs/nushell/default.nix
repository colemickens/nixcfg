...
rustPlatform.buildRustPackage (
  let
    version = "0.99.1-unstable-2024-10-24";
    rev = "69d81cc065731b2e69fcda7e7c58cc4d67047117";
    owner = "nushell";
    pname = "nushell";
    src = fetchFromGitHub {
      owner = owner;
      repo = pname;
      rev = rev;
      sha256 = "sha256-+UlvzchjdDR5FvKHgxSRSwY8yi7O7Ac7xhtrKwYUqMw=";
    };
  in
  {
    ...
    cargoLock = {
      lockFile = ./Cargo.lock;
      outputHashes = {
        "reedline-0.36.0" = "sha256-PZ0KNx8aTcexCRm2JSgexrEhQhdh4hjDnL41cybkOIw=";
      };
    };
