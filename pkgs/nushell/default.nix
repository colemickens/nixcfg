...
rustPlatform.buildRustPackage (
  let
    version = "0.98.0-unstable-2024-10-07";
    rev = "4c8b09eb97af5d93c587f7cf652cf85ffa093901";
    owner = "nushell";
    pname = "nushell";
    src = fetchFromGitHub {
      owner = owner;
      repo = pname;
      rev = rev;
      sha256 = "sha256-66oYSm1QcVByOhOvErQFIlv7iG0JBl1nLAPPPFr5Xq0=";
    };
  in
  {
    ...
    cargoLock = {
      lockFile = ./Cargo.lock;
      outputHashes = {
        "reedline-0.35.0" = "sha256-PtSWxOWIA7LUHOKB/AzL7KzTluB3iwmNNMYDt6ibcF8=";
      };
    };
