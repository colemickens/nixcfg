...
rustPlatform.buildRustPackage rec {
  pname = "alacritty";
  version = "alacritty_terminal_v0.24.0-unstable-2024-09-07";

  src = fetchFromGitHub {
    owner = "alacritty";
    repo = pname;
    rev = "68f04024a3cbd5bdff68974eb54d1f999a292676";
    hash = "sha256-pCiWGt+G5d2Dhe6xShk3B1gglWNOM+sfNHJCOqeQriI=";
  };
