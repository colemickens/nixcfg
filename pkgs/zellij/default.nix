...
let
  metadata = rec {
    ...
    branch = "main";
    rev = "796b0bca98fb7c2a322e278c719842010aba814a";
    sha256 = "sha256-dYg38XcTCxH0VA8qncNQIoV4MWDaVg7d/fAFc+ZYods=";
    cargoSha256 = "sha256-cnLTWpcM/sTcmIPxd7wI9TovwK9O7uOyLpQV+XuiAO0=";
  };
