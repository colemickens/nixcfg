...
let
  metadata = {
    ...
    branch = "main";
    rev = "98c6cd4650c2efc80fae7e7727d3465190fffc3a";
    sha256 = "sha256-xCdYGhsLjJPo/UImpjbyVGKro6y0ndRU/qcYv6sLX30=";
    vendorSha256 = "sha256-vyrMKHQcDcl4ERsWAJrY+VxHJ5yZCGXVHfCAssO90l8=";
  };
