...
let
  metadata = {
    ...
    branch = "main";
    rev = "750743d1edb778a0dc8f08895078a483de973e21";
    sha256 = "sha256-yy4RZS3daC7uFBEoimF2AJNb4tgo3A9ZbwyID+RglVU=";
    vendorSha256 = "sha256-glvhGrEoiLZYkOOkxV0zmytVENdEtnhC7xzIf+mpqOo=";
  };
