...
let
  metadata = {
    ...
    branch = "main";
    rev = "22d9bdabf86100267a36c381b439417adb78e50f";
    sha256 = "sha256-LGW+e4j3Qh2F8Ei3jzmljG2hGbgIM4Ijwz7EeZv6kG8=";
    vendorSha256 = "sha256-BRhphkjgXo5GykdnxXX2+nATMSBVzlUI6huQst47M6w=";
  };
