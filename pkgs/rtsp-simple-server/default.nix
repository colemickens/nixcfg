...
let
  metadata = {
    ...
    branch = "main";
    rev = "b4649ef60b769ca9263c3579a50788d284a1a539";
    sha256 = "sha256-9FkxYOee3Pi8tib4TpwcJoYIEFrKDTOQOvnF9czQsmQ=";
    vendorSha256 = "sha256-hVhQPBlXKvy832WboAStK98C81/GQrbViqHQuWznxYY=";
  };
