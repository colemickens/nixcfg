...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    rev = "227142dd567ee72bcc137c116bc1ce2b818975e7";
    hash = "sha256-kY3FpbQQKMkOUU9107V7yIXlNGa0tryE+fe0a6H2YPs=";
  };
  ...
  cargoHash = "sha256-7bRnzQ2BqYfMH8NEBT8uwDkXzeUyhni28eqRGCGjvOc=";
