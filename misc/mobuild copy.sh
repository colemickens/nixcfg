...
# # # function cache() {
# # #   ssh "colemickens@aarch64.nixos.community" "cd ~/code/nixcfg; ./misc/agcache.sh \"${thing}\""
# # # }
# # # trap cache EXIT
...
nix flake lock ~/code/nixcfg --update-input mobile-nixos --commit-lock-file
...
cat "/tmp/${out}-paths" | grep "android"
