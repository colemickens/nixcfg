...
function update() {
  ...
  METADATA_FILE="${NIXPKGS}/pkgs/os-specific/linux/firmware/raspberrypi-wireless/default.nix"
  UPDATE_ATTR="${NIXPKGS}#legacyPackages.${ARCH}.raspberrypiWirelessFirmware"
  ...
  if [[ "${OLD_BTFW_REV}" != "${NEW_BTFW_REV}" ||  "${OLD_WIFIFW_REV}" != "${NEW_WIFIFW_REV}" ]]; then
    ...
    git -C "${NIXPKGS}" commit "${METADATA_FILE}" -m "${commitmsg}" --no-gpg-sign
  fi
  ...
  METADATA_FILE="${NIXPKGS}/pkgs/os-specific/linux/raspberrypi-eeprom/default.nix"
  UPDATE_ATTR="${NIXPKGS}#legacyPackages.${ARCH}.raspberrypi-eeprom"
  ...
  METADATA_FILE="${NIXPKGS}/pkgs/os-specific/linux/firmware/raspberrypi/default.nix"
  UPDATE_ATTR="${NIXPKGS}#legacyPackages.${ARCH}.raspberrypifw"
  ...
  METADATA_FILE="${NIXPKGS}/pkgs/os-specific/linux/firmware/raspberrypi/master.nix"
  UPDATE_ATTR="${NIXPKGS}#legacyPackages.${ARCH}.raspberrypifw-master"
  ...
  METADATA_FILE="${NIXPKGS}/pkgs/os-specific/linux/firmware/raspberrypi/armstubs.nix"
  UPDATE_ATTR="${NIXPKGS}#legacyPackages.${ARCH}.raspberrypi-armstubs"
  ...
  METADATA_FILE="${NIXPKGS}/pkgs/development/libraries/libraspberrypi/default.nix"
  UPDATE_ATTR="${NIXPKGS}#legacyPackages.${ARCH}.libraspberrypi"
  ...
  METADATA_FILE="${NIXPKGS}/pkgs/os-specific/linux/kernel/linux-rpi.nix"
  UPDATE_ATTR="${NIXPKGS}#legacyPackages.${ARCH}.linuxPackages_rpi4.kernel"
