...
in
{
  ...
  config = {
    ...
    boot.loader.grub.configurationLimit = lib.mkForce 1;
    boot.initrd.compressor = "zstd";
    boot.initrd.compressorArgs = [ "--ultra" ];
    ...
    boot.initrd.kernelModules = [
      ...
      "ehci_pci"
      "uas"
      "virtio_scsi" # so we can test virtualbox's virtio-scsi host supoprt
    ];
